...
namespace DisCatSharp.Examples.Interactivity.Commands
{
    ...
    public class InteractivityCommands : ApplicationCommandsModule
    {
        ...
        public static async Task SelectMenu(InteractionContext ctx)
        {
            ...
            response.AddComponents(new DiscordSelectComponent("select_menu", "Choose something", options));
            ...
            var result = await interactivity.WaitForSelectAsync(msg, ctx.Member, "select_menu", TimeSpan.FromMinutes(5));
