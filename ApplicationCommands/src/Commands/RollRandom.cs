...
namespace DisCatSharp.Examples.ApplicationCommands.Commands
{
	...
	public class RollRandom : ApplicationCommandsModule
	{
		...
		public static async Task Command(InteractionContext context, [Option("random_choice", "Should a random number, role or user be picked?")] RandomChoice randomChoice = RandomChoice.Number)
		{
